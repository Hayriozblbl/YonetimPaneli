                ...
                <div class="x_panel">
                   <div class="x_title">
                    ...
                    <div class="col-md-6" align="right">
                     <a href="slider.php"><button class="btn btn-warning btn-xs"><i class="fa fa-undo" aria-hidden="true"></i>Geri Gön</button></a> 
                    </div>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../netting/islem.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <img width="200" height="100" src="../../assets/img/slider/<?php echo $slidercek['slider_resimyol']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Site Açıklama(Link)<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" name="slider_sira" value="<?php echo $slidercek['slider_sira'];?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button name="sliderduzenle" type="submit" class="btn btn-primary">Güncelle</button>
                      </div>
