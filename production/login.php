...
<html lang="en">
  <head>
    ...
    <title>Arslan Yapı Yönetim Paneli</title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../netting/islem.php" method="POST">
              ...
              <div>
                <button style="width: 100%; " type="submit" name="loggin" class="btn btn-default"> Giriş Yap</button>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>© Hayri Özbülbül Tarafından kodlanmıştır...</p>
                </div>
              </div>
            </form>
          </section>
