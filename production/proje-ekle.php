                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../netting/islem.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="first-name" name="proje_resim" required="required" class="form-control col-md-7 col-xs-12"  >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="proje_ad" required="required" class="form-control col-md-7 col-xs-12"  >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="proje_sira" value="0" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button name="projekaydet" type="submit" class="btn btn-primary">Kaydet</button>
                      </div>
